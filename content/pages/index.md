...
sections:
  - type: GenericSection
    title:
      text: Vind De Mooiste Hobby Artikelen En Huis Tuin Decoratie Artikelen
      color: text-dark
      type: TitleBlock
    ...
    actions:
      ...
      - label: Huis Tuin Decoratie
        ...
        url: 'https://www.boeddha-beelden.com'
        showIcon: true
        icon: arrowRight
        iconPosition: right
        style: primary
  ...
  - type: FeaturedItemsSection
    ...
    actions:
      - label: Meer Informatie
        ...
        type: Button
    badge:
      label: Hobbies Huis en Tuindecoratie
      color: text-primary
      styles:
        self:
          textAlign: center
  ...
  - title: Divider
    ...
    type: DividerSection
  - title:
      text: Laat je business 10x sneller groeien
      color: text-dark
      styles:
        self:
          textAlign: center
    ...
    media:
      ...
      url: 'https://youtube.com/shorts/I2v7YuiVu4U?si=SFil5u7xz6qM0swi'
      controls: false
      aspectRatio: '16:9'
      styles:
        self:
